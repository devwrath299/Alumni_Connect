...
public class EditProfile_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.activity().setCropShape(CropImageView.CropShape.OVAL).start(EditProfile_activity.this);
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                updateProfile();
                Intent intent = new Intent(EditProfile_activity.this, Start_activity.class);
                intent.putExtra("PublisherId",fUser.getUid());
                startActivity(intent);
                finish();
                Toast.makeText(EditProfile_activity.this, "Profile updated Sucessfull", Toast.LENGTH_SHORT).show();
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        pd.dismiss();
                        Toast.makeText(EditProfile_activity.this, "Upload failed!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
